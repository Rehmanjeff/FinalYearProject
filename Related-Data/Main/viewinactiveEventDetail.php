...
$sql="SELECT * FROM event WHERE id = ".$_GET["eventId"];
...
while($row=  mysqli_fetch_assoc($result)){
    ...
    <div class="infoTab">
        ...
        <center><div class="row">';
            $sql="SELECT * FROM gallary WHERE album_FK = ".$_GET["eventId"];
            $album= mysqli_query($link,$sql);

            $photo=mysqli_fetch_array($album);

                echo '
                <div class="col-md-12">
                    <a href="?showAlbum='.$photo['album_FK'].'"><img src="gallary/'.$photo['file'].'" width="400px" height="400px"></a>
                    <span class="caption">'.$photo['file'].'</span>
                </div>';
